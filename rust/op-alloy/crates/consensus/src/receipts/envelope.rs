...
impl<T> OpReceiptEnvelope<T> {
    ...
    pub fn map_logs<U>(self, f: impl FnMut(T) -> U) -> OpReceiptEnvelope<U> {
        match self {
            ...
            Self::Eip4844(r) => OpReceiptEnvelope::Eip4844(r.map_logs(f)),
    ...
    pub const fn logs_bloom(&self) -> &Bloom {
        match self {
            Self::Legacy(t) | Self::Eip2930(t) | Self::Eip1559(t) | Self::Eip4844(t) | Self::Eip7702(t) => {
                &t.logs_bloom
            }
    ...
    pub fn into_receipt(self) -> Receipt<T> {
        match self {
            Self::Legacy(t) | Self::Eip2930(t) | Self::Eip1559(t) | Self::Eip4844(t) | Self::Eip7702(t) => t.receipt,
...
impl OpReceiptEnvelope {
    ...
    pub fn inner_length(&self) -> usize {
        match self {
            Self::Legacy(t) | Self::Eip2930(t) | Self::Eip1559(t) | Self::Eip4844(t) | Self::Eip7702(t) => t.length(),
