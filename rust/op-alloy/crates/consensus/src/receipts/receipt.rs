...
impl<T> OpReceipt<T> {
    ...
    pub fn map_logs<U>(self, f: impl FnMut(T) -> U) -> OpReceipt<U> {
        match self {
            ...
            Self::Eip4844(receipt) => OpReceipt::Eip4844(receipt.map_logs(f)),
        ...
        T: Decodable,
    {
        ...
        match tx_type {
            ...
            OpTxType::Eip4844 => Ok(Self::Eip4844(Receipt { status, cumulative_gas_used, logs })),
...
impl From<super::OpReceiptEnvelope> for OpReceipt {
    fn from(envelope: super::OpReceiptEnvelope) -> Self {
        match envelope {
            ...
            super::OpReceiptEnvelope::Eip4844(receipt) => Self::Eip4844(receipt.receipt),
...
impl<T> From<ReceiptWithBloom<OpReceipt<T>>> for OpReceiptEnvelope<T> {
    fn from(value: ReceiptWithBloom<OpReceipt<T>>) -> Self {
        ...
        match receipt {
            ...
            OpReceipt::Eip4844(receipt) => Self::Eip4844(ReceiptWithBloom { receipt, logs_bloom }),
    ...
    impl<'a> From<&'a super::OpReceipt> for OpReceipt<'a> {
        fn from(value: &'a super::OpReceipt) -> Self {
            match value {
                ...
                super::OpReceipt::Eip4844(receipt) => Self::Eip4844(receipt.into()),
    ...
    impl<'a> From<OpReceipt<'a>> for super::OpReceipt {
        fn from(value: OpReceipt<'a>) -> Self {
            match value {
                ...
                OpReceipt::Eip4844(receipt) => Self::Eip4844(receipt.into()),
